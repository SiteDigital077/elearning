       ...
       <div class="card">
        <div class="card-body">
         <div class="col-lg-12 card-form__body card-body">
          {{ Form::open(array('method' => 'POST','class' => 'form-horizontal','id' => 'defaultForm1', 'url' => array('gestion/elearning/crearversion'))) }}
                                
          <div class="form-group">
           <label for="exampleInputEmail1">Producto:</label>
            {{Form::text('producto', '', array('class' => 'form-control','id'=>'flatpickrSample02','placeholder'=>'Ingrese producto','maxlength' => '150', 'min' => '0'))}}
          </div>                                
          
          <div class="form-group">
           <label for="exampleInputEmail1">Versión producto:</label>
           {{Form::text('version', '', array('class' => 'form-control','id'=>'flatpickrSample02','placeholder'=>'Ingrese versión','maxlength' => '150', 'min' => '0'))}} 
          </div>
