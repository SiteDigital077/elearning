       ...
       <div class="card">
        <div class="card-body">
         <div class="col-lg-12 card-form__body card-body">
          {{ Form::open(array('method' => 'POST','class' => 'form-horizontal','id' => 'defaultForm1', 'url' => array('gestion/elearning/crearprograma'))) }}
                                
          <div class="form-group">
           <label for="exampleInputEmail1">Programa:</label>
            {{Form::text('programa', '', array('class' => 'form-control','id'=>'flatpickrSample02','placeholder'=>'Ingrese producto','maxlength' => '150', 'min' => '0'))}}
          </div>                                
