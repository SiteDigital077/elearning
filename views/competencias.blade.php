        ...
        <div class="page__header flush-shadow">
                <div class="container-fluid page__heading-container">
                    <div class="page__heading d-flex flex-column flex-md-row align-items-center justify-content-center justify-content-lg-between text-center text-lg-left">
                        ...
                        <button type="button" class="btn btn-success ml-lg-3" data-toggle="modal" data-target="#exampleModal">Crear Competencia <i class="material-icons">add</i></button>
                    </div>
                </div>
       ...
       <div class="card">
        <div class="card-body">
         <div class="col-lg-12 card-form__body card-body">
          {{ Form::open(array('method' => 'POST','class' => 'form-horizontal','id' => 'defaultForm1', 'url' => array('gestion/elearning/crearcompetencia'))) }}
                                
          <div class="form-group">
           <label for="exampleInputEmail1">Competencia:</label>
            {{Form::text('competencia', '', array('class' => 'form-control','id'=>'flatpickrSample02','placeholder'=>'Ingrese producto','maxlength' => '150', 'min' => '0'))}}
          </div>                                
  ...
  <div class="table-responsive">
   <table id="example-datatable" class="table table-vcenter table-condensed table-bordered">
    ...
    <tbody>
     ...
     <tr>
      <td class="text-center">{{$competencias->id}}</td>
      <td class="text-center">{{$competencias->competencia}}</td>
      <td>{{$competencias->created_at}}</td>
      <td>{{$competencias->updated_at}}</td>
